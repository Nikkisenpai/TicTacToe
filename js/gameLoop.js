...
function rodada(sqr){
		if(sqr.value == EMPTY_val){
				if(turno==1){
					sqr.value = X_val;
					sqr.style.backgroundImage = "url('image/totoro.png')";
					sqr.style.color = "#ffffff";
				}else{
					sqr.value = O_val;
					sqr.style.backgroundImage = "url('image/doraemon.png')";
					sqr.style.color = "#ffffff";
				}
				turno = turno*(-1);
				validaJogada();
...
function reset(){
	...
	document.gameLoop.sqr1.style.backgroundColor = "black";
	document.gameLoop.sqr2.style.backgroundColor = "black";
	document.gameLoop.sqr3.style.backgroundColor = "black";
	document.gameLoop.sqr4.style.backgroundColor = "black";
	document.gameLoop.sqr5.style.backgroundColor = "black";
	document.gameLoop.sqr6.style.backgroundColor = "black";
	document.gameLoop.sqr7.style.backgroundColor = "black";
	document.gameLoop.sqr8.style.backgroundColor = "black";
	document.gameLoop.sqr9.style.backgroundColor = "black";
